...
map.getView().fit([704198.680511, 8765375.978930, 709283.216088, 8768085.257011], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">New Kasama, Mansa.</h2>';
        return titleElement;
    })(),
